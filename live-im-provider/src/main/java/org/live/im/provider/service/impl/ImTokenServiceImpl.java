package org.live.im.provider.service.impl;

import jakarta.annotation.Resource;
import org.live.framework.redis.starter.key.ImProviderCacheKeyBuilder;
...
public class ImTokenServiceImpl implements ImTokenService {
    ...
    public String createImLoginToken(long userId, int appId) {
        ...
        redisTemplate.opsForValue().set(cacheKeyBuilder.buildImLoginTokenKey(token), userId,5, TimeUnit.SECONDS);
        return token;
    }
